...
/**
 * The static class load a static file.
 *
 * @category	core
 * @package		sinergi
 * @author		Sinergi Team
...
class StaticFile {
	...
	private function fileType() {
		preg_match(
			"/.*\.+([txt|js|css|gif|png|jpe?g|pdf|xml|oga|ogg|m4a|ogv|mp4|m4v|webm|svg|svgz|eot|ttf|otf|woff|ico|webp|appcache|manifest|htc|crx|xpi|safariextz|vcf|txt|html|rss|atom|json]+)$/i", 
			Request::$urn, 
			$matches
		);
